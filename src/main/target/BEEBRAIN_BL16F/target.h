...
// *************** RX ******************************
    ...
    #define RX_FRSKY_SPI_GDO_0_PIN      PB2
    #define RX_FRSKY_SPI_LED_PIN        PA13
    #define RX_FRSKY_SPI_TX_EN_PIN      PB10
    #define RX_FRSKY_SPI_ANT_SEL_PIN    PA8
    #define RX_FRSKY_SPI_LNA_EN_PIN     NONE
